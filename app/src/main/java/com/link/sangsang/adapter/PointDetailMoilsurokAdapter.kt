...
import com.link.sangsang.dataclass.PointDetailMoilsurokDataClass

class PointDetailMoilsurokAdapter(
    val context: Context,
    var pointList: ArrayList<PointDetailMoilsurokDataClass>
) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    private val deAd: ArrayList<PointDetailMoilsurokDataClass> = arrayListOf()
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        var viewHolder = (holder as PointDetailMoilsurokAdapter.ViewHolder).itemView
        val point: PointDetailMoilsurokDataClass = pointList[position]
    ...
    fun replaceList(newList: MutableList<PointDetailMoilsurokDataClass>) {
        pointList = newList.toMutableList() as ArrayList<PointDetailMoilsurokDataClass>
