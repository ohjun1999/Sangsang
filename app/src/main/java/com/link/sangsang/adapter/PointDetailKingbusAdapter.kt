...
import com.link.sangsang.dataclass.PointDetailKingbusDataClass

class PointDetailKingbusAdapter(val context: Context, var pointList: ArrayList<PointDetailKingbusDataClass>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    private val deAd: ArrayList<PointDetailKingbusDataClass> = arrayListOf()
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        var viewHolder = (holder as PointDetailKingbusAdapter.ViewHolder).itemView
        val point: PointDetailKingbusDataClass = pointList[position]
    ...
    fun replaceList(newList: MutableList<PointDetailKingbusDataClass>) {
        pointList = newList.toMutableList() as ArrayList<PointDetailKingbusDataClass>
